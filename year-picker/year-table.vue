...
<style scoped>
  ...
  .el-year-table td.today .cell {
    color: #0965c6;
    //border: 1px solid rgba(193, 163, 114, 1);
    font-weight: 700;
    border-radius: 18px;
  }
  ...
  .el-year-table td.end-date div, .el-year-table td.start-date div {
    color: #fff
  }
  ...
  .el-year-table .today.in-range:hover .cell, .el-year-table td.end-date .cell, .el-year-table td.start-date .cell {
    color: #fff;
    background-color: #0965c6;
    border-radius: 18px;
  }
